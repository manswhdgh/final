...
<body>
	...
	<div class="div2">
 	<p class="p2">물품정보</p>
		<table class="table">
			...
			<tr>
				<td class="firtd1">구매번호</td>
				<td class="firtd3"></td>
				<td class="firtd1">구매일자</td>
				<td class="firtd3"></td>
			</tr>
			<tr>
				<td class="firtd1">거래수량</td>
				<td class="firtd3"></td>
				<td class="firtd1">판매금액</td>
				<td class="firtd3">원</td>
			</tr>
			<tr>
				<td class="firtd1">캐릭터명</td>
				<td colspan="3" class="firtd3"><input type="text">(물품을 전달하실 캐릭터명을 입력하세요)</td>
		</table>
 	</div>
 	<div class="div3">
 		<button class="button">판매하기</button>
 	</div>
 	<div class="div4">
 		<table class="table">
 			<tr>
	...
	<div class="div5">
		...
		<table class="table">
			<tr>
				<td rowspan="2" class="lasttd1">내정보</td>
				<td class="lasttd2">이름</td>
				<td class="lasttd3"></td>
			</tr>
			<tr>
				<td class="lasttd2">연락처</td>
				<td class="lasttd3"></td>
			</tr>
		</table>
