...
<body>
	<table class="table">
		...
		<tr>
			<td colspan="2" class="attd1">판매유형 </td>
			<td class="attd2">
			&nbsp;
			<span class="gp">일반<input type="radio" name="itemgroup" value="item"></span>
			&nbsp;
			<span class="gp">교환<input type="radio" name="itemgroup" value="gamemoney"></span>
			</td>
		</tr>
		<tr>
			<td colspan="2" class="attd1">판매수량</td>
			<td class="attd2">
			&nbsp;
		...
		<tr>
			<td colspan="2" class="attd1">판매금액</td>
			<td class="attd2">
			&nbsp;
		...
		<tr>
			...
			<td class="attd2">
			&nbsp;
			<input class="number" type="text" name="character_name"><span class="gp"> 물품을 전달 할 본인의 캐릭터명</span>
			</td>
		</tr>
		<tr>
			<td colspan="2" class="attd1">물품제목</td>
			<td class="attd2">
			&nbsp;
